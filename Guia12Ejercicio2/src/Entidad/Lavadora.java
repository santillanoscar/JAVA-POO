...
//el atributo propio de la lavadora.
        ...
        System.out.println(" Crear una Lavadora");
        System.out.println("--------------------");
...
//visto en la clase Electrodoméstico también deben afectar al precio.
    ...
    public String toString() {
        return "Electrodomesticos{" + "precio= $" + precio + ", color= " + color + ", consumoEnergetico= " + consumoEnergetico + ", peso= " + peso + "Kg carga= " + carga + " Kg" + '}';
    }
